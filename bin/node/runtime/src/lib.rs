...
use frame_support::{
    ...
    traits::{
        Currency, Contains, Everything, Imbalance, KeyOwnerProofSystem, LockIdentifier, Nothing,
...
use xcm_builder::{
    AccountId32Aliases, AllowTopLevelPaidExecutionFrom, AllowUnpaidExecutionFrom, CurrencyAdapter as XCMCurrencyAdapter,
