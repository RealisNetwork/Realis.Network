...
pub use chain_spec::ChainSpec as RealisChainSpec;
...
pub use service::{
    ChainSpec,
    config::{DatabaseSource, PrometheusConfig}, Configuration, Error as SubstrateServiceError, PruningMode, Role, RuntimeGenesis,
    TaskManager, TFullBackend, TFullCallExecutor, TFullClient, TransactionPoolOptions,
};
...
#[cfg(feature = "full-node")]
pub struct Basics<RuntimeApi, ExecutorDispatch>
    where
...
#[cfg(feature = "full-node")]
pub fn new_partial<RuntimeApi, ExecutorDispatch, ChainSelection>(
    config: &mut Configuration,
...
> {
    ...
    // #[cfg(feature = "polkadot-native")]
    {
        return chain_ops!(config, jaeger_agent, telemetry_worker_handle; node_runtime, PolkadotExecutorDispatch, Polkadot)
    }
...
pub fn build_full(
    ...
    #[cfg(feature = "polkadot-native")]
    {
        return new_full::<node_runtime::RuntimeApi, PolkadotExecutorDispatch, _>(
            config,
            is_collator,
            grandpa_pause,
            disable_beefy,
