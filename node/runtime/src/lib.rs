...
use frame_support::{
    ...
    traits::{
        Contains, Currency, Everything, InstanceFilter, KeyOwnerProofSystem, LockIdentifier, Nothing,
...
use sp_runtime::{
    ...
    traits::{
        AccountIdLookup, self, BlakeTwo256, Block as BlockT, ConvertInto, OpaqueKeys,
        SaturatedConversion,
    },
...
use sp_std::{cmp::Ordering, collections::btree_map::BTreeMap, vec, prelude::*};
...
impl frame_system::Config for Runtime {
    ...
    type SystemWeightInfo = weight::frame_system::WeightInfo<Runtime>;
...
impl pallet_scheduler::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_scheduler::WeightInfo<Runtime>;
}
...
impl pallet_indices::Config for Runtime {
    ...
    type Event = Event;
    type WeightInfo = weight::pallet_indices::WeightInfo<Runtime>;
}
...
impl pallet_election_provider_multi_phase::Config for Runtime {
    ...
    >;
    type WeightInfo = weight::pallet_election_provider_multi_phase::WeightInfo<Self>;
...
impl pallet_bags_list::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_bags_list::WeightInfo<Runtime>;
...
impl pallet_staking::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_staking::WeightInfo<Runtime>;
...
impl pallet_identity::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_identity::WeightInfo<Runtime>;
}
...
impl pallet_democracy::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_democracy::WeightInfo<Runtime>;
...
impl pallet_collective::Config<CouncilCollective> for Runtime {
    ...
    type WeightInfo = weight::pallet_collective_council::WeightInfo<Runtime>;
}
...
impl pallet_elections_phragmen::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_elections_phragmen::WeightInfo<Runtime>;
}
...
impl pallet_collective::Config<TechnicalCollective> for Runtime {
    ...
    type DefaultVote = pallet_collective::PrimeDefaultVote;
    type WeightInfo = weight::pallet_collective_technical_committee::WeightInfo<Runtime>;
}
...
impl pallet_membership::Config<pallet_membership::Instance1> for Runtime {
    ...
    type MaxMembers = TechnicalMaxMembers;
    type WeightInfo = weight::pallet_membership::WeightInfo<Runtime>;
}
...
impl pallet_bounties::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_bounties::WeightInfo<Runtime>;
}
...
impl pallet_tips::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_tips::WeightInfo<Runtime>;
}
...
impl pallet_im_online::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_im_online::WeightInfo<Runtime>;
...
impl claims::Config for Runtime {
    ...
    type MoveClaimOrigin =
        pallet_collective::EnsureProportionAtLeast<_3, _4, AccountId, CouncilCollective>;
    type WeightInfo = weight::runtime_common_claims::WeightInfo<Runtime>;
}
...
impl pallet_vesting::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_vesting::WeightInfo<Runtime>;
...
impl pallet_utility::Config for Runtime {
    ...
    type Call = Call;
    type PalletsOrigin = OriginCaller;
    type WeightInfo = weight::pallet_utility::WeightInfo<Runtime>;
}
...
impl pallet_multisig::Config for Runtime {
    ...
    type WeightInfo = weight::pallet_multisig::WeightInfo<Runtime>;
}
...
impl parachains_configuration::Config for Runtime {
    type WeightInfo = weight::runtime_parachains_configuration::WeightInfo<Runtime>;
}
...
impl parachains_inclusion::Config for Runtime {
    ...
    type RewardValidators = crate::reward_points::RewardValidatorsWithEraPoints<Self>;
}

impl parachains_paras::Config for Runtime {
    type Origin = Origin;
    type Event = Event;
    type WeightInfo = weight::runtime_parachains_paras::WeightInfo<Runtime>;
}
...
impl parachains_paras_inherent::Config for Runtime {
    type WeightInfo = weight::runtime_parachains_paras_inherent::WeightInfo<Runtime>;
}
...
impl paras_registrar::Config for Runtime {
    ...
    type WeightInfo = weight::runtime_common_paras_registrar::WeightInfo<Runtime>;
}
...
impl slots::Config for Runtime {
    ...
    type WeightInfo = weight::runtime_common_slots::WeightInfo<Runtime>;
}
...
impl crowdloan::Config for Runtime {
    ...
    type WeightInfo = weight::runtime_common_crowdloan::WeightInfo<Runtime>;
}
...
impl auctions::Config for Runtime {
    ...
    type WeightInfo = weight::runtime_common_auctions::WeightInfo<Runtime>;
}
...
frame_support::construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        Sudo: pallet_sudo::{Pallet, Call, Config<T>, Storage, Event<T>} = 38,
...
sp_api::impl_runtime_apis! {
    ...
    impl sp_block_builder::BlockBuilder<Block> for Runtime {
        ...
        fn check_inherents(block: Block, data: inherents::InherentData) -> inherents::CheckInherentsResult {
    ...
    impl beefy_primitives::BeefyApi<Block> for Runtime {
		fn validator_set() -> beefy_primitives::ValidatorSet<BeefyId> {
			// dummy implementation due to lack of BEEFY pallet.BeefyId
    ...
    impl sp_consensus_babe::BabeApi<Block> for Runtime {
        fn configuration() -> sp_consensus_babe::BabeGenesisConfiguration {
            // The choice of `c` parameter (where `1 - c` represents the0
