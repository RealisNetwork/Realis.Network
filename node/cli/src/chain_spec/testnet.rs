...
use node_runtime::{
    wasm_binary_unwrap,
    AuthorityDiscoveryConfig, BabeConfig,
    BalancesConfig, /*CouncilConfig,*/ SudoConfig,
    ...
    /*SocietyConfig,*/ StakerStatus, StakingConfig, SystemConfig,
    /*TechnicalCommitteeConfig,*/ MaxNominations
};
...
pub fn testnet_genesis(
    ...
    let stakers = initial_authorities
        ...
        .chain(initial_nominators.iter().map(|x| {
            ...
            let limit = (MaxNominations as usize).min(initial_authorities.len());
