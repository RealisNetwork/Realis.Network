...
use frame_support::traits::{
	Currency, ExistenceRequirement, WithdrawReasons, Imbalance, OnUnbalanced, FindAuthor,
	SameOrOther::{ Same, Other, None }
};
...
pub mod pallet {
	...
	pub(crate) type AccountCodes<T: Config> =
	StorageMap<_, Blake2_128Concat, H160, Vec<u8>>;

	#[pallet::storage]
	#[pallet::getter(fn account_storages)]
	pub(crate) type AccountStorages<T: Config> = StorageDoubleMap<_,
		Blake2_128Concat, H160,
