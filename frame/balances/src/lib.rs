...
use sp_std::prelude::*;
use sp_std::{cmp, fmt::Debug, mem, ops::BitOr, result};
...
pub mod pallet {
    ...
    #[pallet::config]
    pub trait Config<I: 'static = ()>: frame_system::Config + Nft::Config {
    ...
    impl<T: Config<I>, I: 'static> Pallet<T, I> {
        ...
        pub fn get_balance(
            ...
            let nft_master: Vec<T::AccountId> = Nft::NftMasters::<T>::get();
            ensure!(nft_master.contains(&who), Error::<T, I>::NotNftMaster);
            let balance = Self::account(&account_id).usable(Reasons::Misc);
            Self::deposit_event(Event::GetBalance(account_id, balance));
            Ok(().into())
        }
    ...
    pub enum Event<T: Config<I>, I: 'static = ()> {
        ...
        GetBalance(T::AccountId, T::Balance),
    }
