...
decl_module! {
    ...
    pub struct Module<T: Config> for enum Call where origin: frame_system::Origin<T> {
        ...
        fn transact(_origin, transaction: ethereum::Transaction) -> DispatchResultWithPostInfo {
            // ensure_none(origin)?;
